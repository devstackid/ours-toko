...
<div class="album">
    <div class="container">
      <div class="col-lg-8">
        <p class="lead text-white">Semua Katalog</p>
        <p>
            @foreach ($catalogues as $catalogue)
            <a href="/catalogues/{{ $catalogue->slug }}" class="btn btn-light my-2">{{ $catalogue->nama_katalog }}</a>
        @endforeach
        </p>
      </div>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col">
              <div class="card shadow-sm">
                ...
                <img src="/{{ $product->image }}" alt="{{ $product->nama_produk }}" class="card-img-top">
                <div class="card-body">
